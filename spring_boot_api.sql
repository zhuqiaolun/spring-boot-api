...
-- ----------------------------
INSERT INTO `logging_event` VALUES ('1591616705258', 'Shutting down ExecutorService \'applicationTaskExecutor\'', 'org.springframework.scheduling.concurrent.ThreadPoolTaskExecutor', 'INFO', 'SpringContextShutdownHook', '0', null, null, null, null, 'ExecutorConfigurationSupport.java', 'org.springframework.scheduling.concurrent.ExecutorConfigurationSupport', 'shutdown', '218', '1255');
...
CREATE TABLE `system_logging_sql` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='自定义日志记录表';
